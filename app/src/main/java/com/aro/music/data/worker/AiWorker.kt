...
import com.aro.music.data.ai.AiOrchestrator
import com.aro.music.data.ai.AiSystemPromptType
import com.aro.music.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.aro.music.data.preferences.AiPreferencesRepository
