package com.aro.music.data.service
...
import com.aro.music.MainActivity
import com.aro.music.R
import com.aro.music.data.model.PlayerInfo
import com.aro.music.data.model.PlaybackQueueItemSnapshot
import com.aro.music.data.model.PlaybackQueueSnapshot
import com.aro.music.data.preferences.EqualizerPreferencesRepository
...
import com.aro.music.data.service.player.TransitionController
import com.aro.music.ui.glancewidget.ControlWidget4x2
import com.aro.music.ui.glancewidget.AroGlanceWidget
import com.aro.music.ui.glancewidget.PlayerActions
import com.aro.music.ui.glancewidget.PlayerInfoStateDefinition
...
import com.aro.music.data.equalizer.EqualizerManager
import com.aro.music.data.model.WidgetThemeColors
...
import com.aro.music.ui.glancewidget.BarWidget4x1
import com.aro.music.ui.glancewidget.GridWidget2x2
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.aro.music.data.preferences.ThemePreference
import com.aro.music.data.service.auto.AutoMediaBrowseTree
import com.aro.music.data.service.wear.buildWearThemePalette
import com.aro.music.data.service.wear.WearStatePublisher
import com.aro.music.presentation.viewmodel.ColorSchemePair
import com.aro.music.shared.WearIntents
import com.aro.music.utils.ArtworkTransportSanitizer
import com.aro.music.utils.MediaItemBuilder
import com.aro.music.data.navidrome.NavidromeRepository
import com.aro.music.di.AppScope
import com.aro.music.presentation.viewmodel.ListeningStatsTracker
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var replayGainManager: com.aro.music.data.media.ReplayGainManager
    @Inject
    ...
    companion object {
        private const val TAG = "MusicService_Aro"
        const val NOTIFICATION_ID = 101
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.aro.music.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.aro.music.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.aro.music"
    ...
    private fun startTemporaryForegroundForCommand() {
        val notification = NotificationCompat.Builder(
            this,
            AroApplication.NOTIFICATION_CHANNEL_ID
        )
    ...
    private val playerListener = object : Player.Listener {
        ...
        override fun onIsPlayingChanged(isPlaying: Boolean) {
            ...
            // Push state immediately so the watch can foreground Aro before
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.aro.music.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.aro.music.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.aro.music.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
    ...
    private suspend fun updateGlanceWidgets(playerInfo: PlayerInfo) = withContext(Dispatchers.IO) {
        try {
            ...
            val glanceIds = glanceManager.getGlanceIds(AroGlanceWidget::class.java)
            glanceIds.forEach { id ->
                updateAppWidgetState(applicationContext, PlayerInfoStateDefinition, id) { widgetPlayerInfo }
                AroGlanceWidget().update(applicationContext, id)
            }
