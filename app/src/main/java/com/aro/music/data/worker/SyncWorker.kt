package com.aro.music.data.worker
...
import com.aro.music.data.database.NeteaseDao
...
import com.aro.music.data.database.resolveAlbumArtUri
import com.aro.music.data.database.serializeArtistRefs
import com.aro.music.data.media.AudioMetadataReader
import com.aro.music.data.model.ArtistRef
...
import com.aro.music.utils.normalizeMetadataTextOrEmpty
import com.aro.music.utils.splitArtistsByDelimiters
...
constructor(
    ...
    companion object {
        const val WORK_NAME = "com.aro.music.data.worker.SyncWorker"
