...
import com.aro.music.data.database.FavoritesEntity
import com.aro.music.data.database.LyricsDao
import com.aro.music.data.database.LyricsEntity
import com.aro.music.data.database.SearchHistoryDao
import com.aro.music.data.database.SearchHistoryEntity
import com.aro.music.data.database.SongEngagementEntity
import com.aro.music.data.database.TransitionDao
import com.aro.music.data.database.TransitionRuleEntity
import com.aro.music.data.preferences.PreferenceBackupEntry
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your Aro backup was created successfully."
            )
        }
    }
