package com.aro.music.data.backup

import android.content.Context
import android.net.Uri
import android.os.Build
import com.aro.music.data.backup.format.BackupReader
import com.aro.music.data.backup.format.BackupWriter
import com.aro.music.data.backup.history.BackupHistoryRepository
import com.aro.music.data.backup.model.BackupHistoryEntry
import com.aro.music.data.backup.model.BackupManifest
...
import com.aro.music.data.backup.model.BackupValidationResult
import com.aro.music.data.backup.model.DeviceInfo
import com.aro.music.data.backup.model.RestorePlan
import com.aro.music.data.backup.model.RestoreResult
import com.aro.music.data.backup.module.BackupModuleHandler
import com.aro.music.data.backup.restore.RestoreExecutor
import com.aro.music.data.backup.restore.RestorePlanner
import com.aro.music.data.backup.validation.ValidationPipeline
...
class BackupManager @Inject constructor(
    ...
    suspend fun export(
        ...
        runCatching {
            ...
            reportProgress(onProgress, BackupOperationType.EXPORT, ++step, totalSteps,
                "Backup complete", "Your Aro backup was created successfully.")
        }
    }
