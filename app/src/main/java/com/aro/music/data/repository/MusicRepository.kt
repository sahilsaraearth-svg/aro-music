...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.aro.music.data.model.StorageFilter = com.aro.music.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.aro.music.data.model.SortOption = com.aro.music.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.aro.music.data.model.StorageFilter = com.aro.music.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.aro.music.data.model.SortOption = com.aro.music.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.aro.music.data.model.StorageFilter = com.aro.music.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.aro.music.data.model.SortOption = com.aro.music.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.aro.music.data.model.StorageFilter = com.aro.music.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.aro.music.data.model.SortOption = com.aro.music.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.aro.music.data.model.StorageFilter = com.aro.music.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     * @param isFavorite Estado objetivo.
     */
    suspend fun setFavoriteStatusWithSong(song: com.aro.music.data.model.Song, isFavorite: Boolean)
     ...
     */
    fun getGenres(): Flow<List<com.aro.music.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.aro.music.data.model.StorageFilter = com.aro.music.data.model.StorageFilter.ALL
    ): Flow<List<com.aro.music.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.aro.music.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.aro.music.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.aro.music.data.database.TelegramTopicEntity>
    fun getAllTelegramTopics(): Flow<List<com.aro.music.data.database.TelegramTopicEntity>>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.aro.music.data.telegram.TelegramRepository
