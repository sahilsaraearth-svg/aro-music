...
import com.aro.music.data.database.AiCacheEntity
...
class AiOrchestrator @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        return try {
            ...
            throw com.aro.music.data.ai.provider.AiProviderSupport.createException(
            ...
            val failure = com.aro.music.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.aro.music.data.ai.provider.AiClient,
        failure: com.aro.music.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.aro.music.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.aro.music.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.aro.music.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
