package com.aro.music.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.aro.music.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.aro.music.data.remote.qqmusic.QQSignGenerator(context)
        ))
