...
import com.aro.music.data.database.AlbumArtThemeEntity
import com.aro.music.data.database.StoredColorSchemeValues
import com.aro.music.data.database.toComposeColor
import com.aro.music.utils.LocalArtworkUri
import com.aro.music.ui.theme.clearExtractedColorCache
import com.aro.music.ui.theme.extractSeedColor
import com.aro.music.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.aro.music.ui.theme.ColorExtractionConfig(
