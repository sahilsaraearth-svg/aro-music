package com.aro.music.presentation.navigation

import DelimiterConfigScreen
import com.aro.music.presentation.screens.WordDelimiterConfigScreen
...
import com.aro.music.presentation.screens.AlbumDetailScreen
import com.aro.music.presentation.screens.AccountsScreen
import com.aro.music.presentation.screens.ArtistDetailScreen
import com.aro.music.presentation.screens.ArtistSettingsScreen
import com.aro.music.presentation.screens.DailyMixScreen
import com.aro.music.presentation.screens.EditTransitionScreen
import com.aro.music.presentation.screens.EasterEggScreen
import com.aro.music.presentation.screens.ExperimentalSettingsScreen
import com.aro.music.presentation.screens.GenreDetailScreen
import com.aro.music.presentation.screens.HomeScreen
import com.aro.music.presentation.screens.LibraryScreen
import com.aro.music.presentation.screens.MashupScreen
import com.aro.music.presentation.screens.NavBarCornerRadiusScreen
import com.aro.music.presentation.screens.PaletteStyleSettingsScreen
import com.aro.music.presentation.screens.PlaylistDetailScreen
import com.aro.music.presentation.screens.RecentlyPlayedScreen

import com.aro.music.presentation.screens.AboutScreen
import com.aro.music.presentation.screens.SearchScreen
import com.aro.music.presentation.screens.StatsScreen
import com.aro.music.presentation.screens.SettingsScreen
import com.aro.music.presentation.screens.SettingsCategoryScreen
import com.aro.music.presentation.screens.EqualizerScreen
...
import com.aro.music.presentation.components.ScreenWrapper
    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.aro.music.presentation.screens.DeviceCapabilitiesScreen(
                        navController = navController,
                        playerViewModel = playerViewModel
                    )
                }
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.aro.music.presentation.netease.dashboard.NeteaseDashboardScreen(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.aro.music.presentation.qqmusic.dashboard.QqMusicDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.aro.music.presentation.navidrome.dashboard.NavidromeDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.aro.music.presentation.jellyfin.dashboard.JellyfinDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
