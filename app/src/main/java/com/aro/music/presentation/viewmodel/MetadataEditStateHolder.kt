...
import com.aro.music.data.media.ImageCacheManager
import com.aro.music.data.media.MetadataEditError
...
import com.aro.music.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.aro.music.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
